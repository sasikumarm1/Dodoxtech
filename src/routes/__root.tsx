...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "DodoX Tech builds custom digital solutions, AI automation, ERPNext customization and admin dashboards. Build smarter. Grow faster.",
      },
      { name: "author", content: "DodoX Tech" },
      { property: "og:title", content: "DodoX Tech — Software & AI Automation Studio" },
      {
        property: "og:description",
        content: "DodoX Tech builds custom digital solutions, AI automation, ERPNext customization and admin dashboards.",
      },
