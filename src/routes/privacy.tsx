...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [
      { title: "Privacy Policy — DodoX Tech" },
      { name: "description", content: "Privacy Policy for DodoX Tech — Coming Soon." },
      { property: "og:url", content: "http://dodoxtechs.in/privacy" },
    ],
    links: [
      {
        rel: "canonical",
        href: "http://dodoxtechs.in/privacy",
      },
    ],
  }),
});
        ...
        <div className="text-center max-w-lg">
          <motion.div initial={{ scale: 0.7, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }} className="relative inline-flex items-center justify-center mb-8">
            ...
            <div className="relative h-20 w-20 rounded-2xl glass-strong border border-white/10 flex items-center justify-center">
              <ShieldCheck className="h-9 w-9 text-[#67e8f9]" strokeWidth={1.5} />
            </div>
          </motion.div>
          ...
          <motion.h1 initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.55 }} className="text-4xl sm:text-5xl font-bold tracking-tight leading-[1.08] mb-5">
            Privacy Policy<br />
            <span className="italic font-light text-white/50">is being prepared.</span>
          </motion.h1>
          ...
          <motion.p initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.42, duration: 0.5 }} className="text-white/50 text-base leading-relaxed mb-10">
            We take your privacy seriously. Our full Privacy Policy is currently being drafted and will be published here shortly. In the meantime, feel free to reach out with any questions.
          </motion.p>
          ...
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.55, duration: 0.45 }} className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="mailto:dodoxtechstudio@gmail.com?subject=Privacy%20Inquiry%20—%20DodoX%20Tech" className="inline-flex items-center justify-center gap-2 rounded-full silver-gradient text-[#030712] px-7 py-3 text-sm font-bold hover:-translate-y-0.5 transition-transform duration-300">
              Contact Us
            </a>
